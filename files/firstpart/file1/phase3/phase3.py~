...
f = codecs.open('/media/34227B6E227B3448/projectBooKmarks/mid_sem/file1/phase1/heading1.csv', 'r', 'utf-8-sig')
...
#eliminating h1 elements from rawtext 
#f = open("/media/34227B6E227B3448/projectBooKmarks/mid_sem/phase2/rawtoken1.csv")

#raw = f.read()

#rtoken = nltk.word_tokenize(raw)

#raw2 = sorted(set(rtoken) - set(hword))


#updating the raw text file

#f= open("rawtoken2.csv", "w")   #this will be used for further processing
...
#f = open("/media/34227B6E227B3448/projectBooKmarks/mid_sem/phase2/rfilter1.csv")
...
#rfilter2 = sorted(set(rfilter_token) - set(hfilter))  

#updating the raw filter file
 
#f= open("rfilter2.csv", "w")   #this will be used for futher processing
