...
words=re.compile(r'[^A-Z^a-z]+').split(clean_str)
...
titlestr = " ".join(clean_title)
	

#Split words by all non-alpha characters
words=re.compile(r'[^A-Z^a-z]+').split(titlestr)
...
#Split words by all non-alpha characters
words=re.compile(r'[^A-Z^a-z]+').split(head1)
...
#Split words by all non-alpha characters
words=re.compile(r'[^A-Z^a-z]+').split(head2)
...
#Split words by all non-alpha characters
words=re.compile(r'[^A-Z^a-z]+').split(head3)
...
#Split words by all non-alpha characters
words=re.compile(r'[^A-Z^a-z]+').split(head4)
...
#Split words by all non-alpha characters
words=re.compile(r'[^A-Z^a-z]+').split(head5)
...
#Split words by all non-alpha characters
words=re.compile(r'[^A-Z^a-z]+').split(head6)
